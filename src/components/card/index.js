			...
			<div class={style.cardBox}> 
				...
				<div class={style.cardBoxProfile}>
					...
					<div class={style.cardBoxProfileContent}>
						...
						<div class={style.cardBoxProfileLink}>
							...
							<a href={"https://github.com/" + data.user.github_username}
								 target="_blank">
				...
				<div class={style.cardBoxFooter}>
					...
					<div class={style.cardBoxFooterRight}>
						<div class={style.cardBoxFooterRightPublished}>{this.dateFormatter(data.published_at)}</div>
						<div class={style.cardBoxFooterRightComment}>{data.comments_count}</div>
						<div class={style.cardBoxFooterRightLike}>{data.positive_reactions_count}</div>
					</div>
				</div>
			</div>		
		)
